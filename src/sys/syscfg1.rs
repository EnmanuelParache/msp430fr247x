...
impl<'a, const O: u8> IREN_W<'a, O> {
    ...
    pub fn dis(self) -> &'a mut W {
        self.variant(IREN_A::DIS)
    }
    #[doc = "Infrared function enabled"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(IREN_A::EN)
    }
}
...
impl<'a, const O: u8> IRPSEL_W<'a, O> {
    ...
    pub fn norm(self) -> &'a mut W {
        self.variant(IRPSEL_A::NORM)
    }
    #[doc = "Inverted polarity"]
    #[inline(always)]
    pub fn inv(self) -> &'a mut W {
        self.variant(IRPSEL_A::INV)
    }
}
...
impl IRMSEL_R {
    ...
    #[doc = "Checks if the value of the field is `ASK`"]
    #[inline(always)]
...
impl<'a, const O: u8> IRMSEL_W<'a, O> {
    #[doc = "ASK mode"]
    #[inline(always)]
    pub fn ask(self) -> &'a mut W {
        self.variant(IRMSEL_A::ASK)
    }
    #[doc = "FSK mode"]
    #[inline(always)]
    pub fn fsk(self) -> &'a mut W {
        self.variant(IRMSEL_A::FSK)
    }
}
...
impl IRDSSEL_R {
    ...
    #[doc = "Checks if the value of the field is `IRDATA`"]
    #[inline(always)]
    pub fn is_irdata(&self) -> bool {
        *self == IRDSSEL_A::IRDATA
    }
}
...
impl<'a, const O: u8> IRDSSEL_W<'a, O> {
    ...
    pub fn hw(self) -> &'a mut W {
        self.variant(IRDSSEL_A::HW)
    }
    #[doc = "From IRDATA bit"]
    #[inline(always)]
    pub fn irdata(self) -> &'a mut W {
        self.variant(IRDSSEL_A::IRDATA)
    }
}
...
impl<'a, const O: u8> IRDATA_W<'a, O> {
    ...
    pub fn low(self) -> &'a mut W {
        self.variant(IRDATA_A::LOW)
    }
    #[doc = "Infrared data logic 1"]
    #[inline(always)]
    pub fn high(self) -> &'a mut W {
        self.variant(IRDATA_A::HIGH)
    }
}
