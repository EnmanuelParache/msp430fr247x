...
pub struct R(crate::R<TA1EX0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TA1EX0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TA1EX0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TA1EX0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TA1EX0` writer"]
pub struct W(crate::W<TA1EX0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TA1EX0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TA1EX0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TA1EX0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TAIDEX_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, TA1EX0_SPEC, u8, TAIDEX_A, 3, O>;
...
pub struct TA1EX0_SPEC;
impl crate::RegisterSpec for TA1EX0_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ta1ex0::R](R) reader structure"]
impl crate::Readable for TA1EX0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ta1ex0::W](W) writer structure"]
impl crate::Writable for TA1EX0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TA1EX0 to value 0"]
impl crate::Resettable for TA1EX0_SPEC {
