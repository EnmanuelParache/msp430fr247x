...
pub struct R(crate::R<TA1CCTL2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TA1CCTL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TA1CCTL2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TA1CCTL2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TA1CCTL2` writer"]
pub struct W(crate::W<TA1CCTL2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TA1CCTL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TA1CCTL2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TA1CCTL2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CCIFG_W<'a, const O: u8> = crate::BitWriter<'a, u16, TA1CCTL2_SPEC, CCIFG_A, O>;
...
pub type COV_W<'a, const O: u8> = crate::BitWriter<'a, u16, TA1CCTL2_SPEC, COV_A, O>;
...
pub type OUT_W<'a, const O: u8> = crate::BitWriter<'a, u16, TA1CCTL2_SPEC, OUT_A, O>;
...
pub type CCIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, TA1CCTL2_SPEC, CCIE_A, O>;
...
pub type OUTMOD_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, TA1CCTL2_SPEC, u8, OUTMOD_A, 3, O>;
...
pub type CAP_W<'a, const O: u8> = crate::BitWriter<'a, u16, TA1CCTL2_SPEC, CAP_A, O>;
...
pub type SCCI_W<'a, const O: u8> = crate::BitWriter<'a, u16, TA1CCTL2_SPEC, bool, O>;
...
pub type SCS_W<'a, const O: u8> = crate::BitWriter<'a, u16, TA1CCTL2_SPEC, SCS_A, O>;
...
pub type CCIS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u16, TA1CCTL2_SPEC, u8, CCIS_A, 2, O>;
...
pub type CM_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u16, TA1CCTL2_SPEC, u8, CM_A, 2, O>;
...
pub struct TA1CCTL2_SPEC;
impl crate::RegisterSpec for TA1CCTL2_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ta1cctl2::R](R) reader structure"]
impl crate::Readable for TA1CCTL2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ta1cctl2::W](W) writer structure"]
impl crate::Writable for TA1CCTL2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TA1CCTL2 to value 0"]
impl crate::Resettable for TA1CCTL2_SPEC {
