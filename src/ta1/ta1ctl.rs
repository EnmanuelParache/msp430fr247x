...
pub struct R(crate::R<TA1CTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TA1CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TA1CTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TA1CTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TA1CTL` writer"]
pub struct W(crate::W<TA1CTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TA1CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TA1CTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TA1CTL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TAIFG_W<'a, const O: u8> = crate::BitWriter<'a, u16, TA1CTL_SPEC, TAIFG_A, O>;
...
pub type TAIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, TA1CTL_SPEC, TAIE_A, O>;
...
pub type TACLR_W<'a, const O: u8> = crate::BitWriter<'a, u16, TA1CTL_SPEC, bool, O>;
...
pub type MC_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u16, TA1CTL_SPEC, u8, MC_A, 2, O>;
...
pub type ID_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u16, TA1CTL_SPEC, u8, ID_A, 2, O>;
...
pub type TASSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, TA1CTL_SPEC, u8, TASSEL_A, 2, O>;
