...
impl From<crate::R<UCB1TBCNT_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<UCB1TBCNT_SPEC>> for W {
    #[inline(always)]
...
pub type UCTBCNT_W<'a, const O: u8> = crate::FieldWriter<'a, u16, UCB1TBCNT_SPEC, u8, u8, 8, O>;
impl R {
