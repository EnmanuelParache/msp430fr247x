...
impl W {
    #[doc = "Bits 0:1 - Deglitch time"]
    #[inline(always)]
    pub fn ucglit(&mut self) -> UcglitW<'_, Ucb1ctlw1Spec> {
        UcglitW::new(self, 0)
    }
    #[doc = "Bits 2:3 - Automatic STOP condition generation"]
    #[inline(always)]
    pub fn ucastp(&mut self) -> UcastpW<'_, Ucb1ctlw1Spec> {
        UcastpW::new(self, 2)
    }
    #[doc = "Bit 4 - SW or HW ACK control"]
    #[inline(always)]
    pub fn ucswack(&mut self) -> UcswackW<'_, Ucb1ctlw1Spec> {
        UcswackW::new(self, 4)
    }
    #[doc = "Bit 5 - ACK all master bytes"]
    #[inline(always)]
    pub fn ucstpnack(&mut self) -> UcstpnackW<'_, Ucb1ctlw1Spec> {
        UcstpnackW::new(self, 5)
    }
    #[doc = "Bits 6:7 - Clock low timeout select"]
    #[inline(always)]
    pub fn ucclto(&mut self) -> UccltoW<'_, Ucb1ctlw1Spec> {
        UccltoW::new(self, 6)
    }
    #[doc = "Bit 8 - Early UCTXIFG0"]
    #[inline(always)]
    pub fn ucetxint(&mut self) -> UcetxintW<'_, Ucb1ctlw1Spec> {
