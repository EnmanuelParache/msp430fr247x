...
pub type R = crate::R<Ucb1i2coa2Spec>;
#[doc = "Register `UCB1I2COA2` writer"]
pub type W = crate::W<Ucb1i2coa2Spec>;
...
impl W {
    #[doc = "Bits 0:9 - I2C own address"]
    #[inline(always)]
    pub fn i2coa2(&mut self) -> I2coa2W<'_, Ucb1i2coa2Spec> {
        I2coa2W::new(self, 0)
    }
    #[doc = "Bit 10 - Own Address enable register"]
    #[inline(always)]
    pub fn ucoaen(&mut self) -> UcoaenW<'_, Ucb1i2coa2Spec> {
        UcoaenW::new(self, 10)
    }
}
#[doc = "eUSCI_Bx I2C Own Address 2 Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ucb1i2coa2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucb1i2coa2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ucb1i2coa2Spec;
impl crate::RegisterSpec for Ucb1i2coa2Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucb1i2coa2::R`](R) reader structure"]
impl crate::Readable for Ucb1i2coa2Spec {}
#[doc = "`write(|w| ..)` method takes [`ucb1i2coa2::W`](W) writer structure"]
impl crate::Writable for Ucb1i2coa2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UCB1I2COA2 to value 0"]
impl crate::Resettable for Ucb1i2coa2Spec {}
