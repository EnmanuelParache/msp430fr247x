...
pub type R = crate::R<Ucb1ivSpec>;
#[doc = "Register `UCB1IV` writer"]
pub type W = crate::W<Ucb1ivSpec>;
...
impl W {}
#[doc = "eUSCI_Bx Interrupt Vector Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ucb1iv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucb1iv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ucb1ivSpec;
impl crate::RegisterSpec for Ucb1ivSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucb1iv::R`](R) reader structure"]
impl crate::Readable for Ucb1ivSpec {}
#[doc = "`write(|w| ..)` method takes [`ucb1iv::W`](W) writer structure"]
impl crate::Writable for Ucb1ivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UCB1IV to value 0"]
impl crate::Resettable for Ucb1ivSpec {}
