...
impl W {
    #[doc = "Bit 5 - Overrun error flag"]
    #[inline(always)]
    pub fn ucoe(&mut self) -> UcoeW<'_, Ucb1statwSpiSpec> {
        UcoeW::new(self, 5)
    }
    #[doc = "Bit 6 - Framing error flag"]
    #[inline(always)]
    pub fn ucfe(&mut self) -> UcfeW<'_, Ucb1statwSpiSpec> {
        UcfeW::new(self, 6)
    }
    #[doc = "Bit 7 - Listen enable"]
    #[inline(always)]
    pub fn uclisten(&mut self) -> UclistenW<'_, Ucb1statwSpiSpec> {
        UclistenW::new(self, 7)
    }
}
#[doc = "UCB1STATW_SPI\n\nYou can [`read`](crate::Reg::read) this register and get [`ucb1statw_spi::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucb1statw_spi::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ucb1statwSpiSpec;
impl crate::RegisterSpec for Ucb1statwSpiSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucb1statw_spi::R`](R) reader structure"]
impl crate::Readable for Ucb1statwSpiSpec {}
#[doc = "`write(|w| ..)` method takes [`ucb1statw_spi::W`](W) writer structure"]
impl crate::Writable for Ucb1statwSpiSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UCB1STATW_SPI to value 0"]
impl crate::Resettable for Ucb1statwSpiSpec {}
