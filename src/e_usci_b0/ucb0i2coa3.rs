...
impl From<crate::R<UCB0I2COA3_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<UCB0I2COA3_SPEC>> for W {
    #[inline(always)]
...
pub type I2COA3_W<'a, const O: u8> = crate::FieldWriter<'a, u16, UCB0I2COA3_SPEC, u16, u16, 10, O>;
...
pub type UCOAEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCB0I2COA3_SPEC, UCOAEN_A, O>;
