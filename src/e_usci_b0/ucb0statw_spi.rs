...
pub struct R(crate::R<UCB0STATW_SPI_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCB0STATW_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCB0STATW_SPI_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCB0STATW_SPI_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCB0STATW_SPI` writer"]
pub struct W(crate::W<UCB0STATW_SPI_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCB0STATW_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCB0STATW_SPI_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCB0STATW_SPI_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCOE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCB0STATW_SPI_SPEC, UCOE_A, O>;
...
pub type UCFE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCB0STATW_SPI_SPEC, UCFE_A, O>;
...
pub type UCLISTEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCB0STATW_SPI_SPEC, UCLISTEN_A, O>;
...
#[doc = "UCB0STATW_SPI\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ucb0statw_spi](index.html) module"]
pub struct UCB0STATW_SPI_SPEC;
impl crate::RegisterSpec for UCB0STATW_SPI_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ucb0statw_spi::R](R) reader structure"]
impl crate::Readable for UCB0STATW_SPI_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucb0statw_spi::W](W) writer structure"]
impl crate::Writable for UCB0STATW_SPI_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UCB0STATW_SPI to value 0"]
impl crate::Resettable for UCB0STATW_SPI_SPEC {
