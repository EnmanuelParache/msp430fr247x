...
pub type R = crate::R<Ta3cctl2Spec>;
#[doc = "Register `TA3CCTL2` writer"]
pub type W = crate::W<Ta3cctl2Spec>;
...
impl W {
    #[doc = "Bit 0 - Capture/compare interrupt flag"]
    #[inline(always)]
    pub fn ccifg(&mut self) -> CcifgW<'_, Ta3cctl2Spec> {
        CcifgW::new(self, 0)
    }
    #[doc = "Bit 1 - Capture overflow"]
    #[inline(always)]
    pub fn cov(&mut self) -> CovW<'_, Ta3cctl2Spec> {
        CovW::new(self, 1)
    }
    #[doc = "Bit 2 - Output"]
    #[inline(always)]
    pub fn out(&mut self) -> OutW<'_, Ta3cctl2Spec> {
        OutW::new(self, 2)
    }
    #[doc = "Bit 4 - Capture/compare interrupt enable"]
    #[inline(always)]
    pub fn ccie(&mut self) -> CcieW<'_, Ta3cctl2Spec> {
        CcieW::new(self, 4)
    }
    #[doc = "Bits 5:7 - Output mode"]
    #[inline(always)]
    pub fn outmod(&mut self) -> OutmodW<'_, Ta3cctl2Spec> {
        OutmodW::new(self, 5)
    }
    #[doc = "Bit 8 - Capture mode"]
    #[inline(always)]
    pub fn cap(&mut self) -> CapW<'_, Ta3cctl2Spec> {
        CapW::new(self, 8)
    }
    #[doc = "Bit 10 - Synchronized capture/compare input"]
    #[inline(always)]
    pub fn scci(&mut self) -> ScciW<'_, Ta3cctl2Spec> {
        ScciW::new(self, 10)
    }
    #[doc = "Bit 11 - Synchronize capture source"]
    #[inline(always)]
    pub fn scs(&mut self) -> ScsW<'_, Ta3cctl2Spec> {
        ScsW::new(self, 11)
    }
    #[doc = "Bits 12:13 - Capture/compare input select"]
    #[inline(always)]
    pub fn ccis(&mut self) -> CcisW<'_, Ta3cctl2Spec> {
        CcisW::new(self, 12)
    }
    #[doc = "Bits 14:15 - Capture mode"]
    #[inline(always)]
    pub fn cm(&mut self) -> CmW<'_, Ta3cctl2Spec> {
        CmW::new(self, 14)
    }
}
#[doc = "Timer_A Capture/Compare Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ta3cctl2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ta3cctl2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ta3cctl2Spec;
impl crate::RegisterSpec for Ta3cctl2Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ta3cctl2::R`](R) reader structure"]
impl crate::Readable for Ta3cctl2Spec {}
#[doc = "`write(|w| ..)` method takes [`ta3cctl2::W`](W) writer structure"]
impl crate::Writable for Ta3cctl2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TA3CCTL2 to value 0"]
impl crate::Resettable for Ta3cctl2Spec {}
