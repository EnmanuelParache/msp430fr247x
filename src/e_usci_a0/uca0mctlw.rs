...
pub type UCOS16_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA0MCTLW_SPEC, UCOS16_A, O>;
...
pub type UCBRF_W<'a, const O: u8> = crate::FieldWriter<'a, u16, UCA0MCTLW_SPEC, u8, u8, 4, O>;
...
pub type UCBRS_W<'a, const O: u8> = crate::FieldWriter<'a, u16, UCA0MCTLW_SPEC, u8, u8, 8, O>;
impl R {
