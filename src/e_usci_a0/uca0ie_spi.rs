...
pub type UCRXIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA0IE_SPI_SPEC, UCRXIE_A, O>;
...
pub type UCTXIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA0IE_SPI_SPEC, UCTXIE_A, O>;
