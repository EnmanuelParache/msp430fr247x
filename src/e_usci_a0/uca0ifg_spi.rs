...
pub type UCRXIFG_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA0IFG_SPI_SPEC, UCRXIFG_A, O>;
...
pub type UCTXIFG_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA0IFG_SPI_SPEC, UCTXIFG_A, O>;
