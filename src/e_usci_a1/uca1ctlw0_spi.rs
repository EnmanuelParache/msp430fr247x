...
impl W {
    #[doc = "Bit 0 - Software reset enable"]
    #[inline(always)]
    pub fn ucswrst(&mut self) -> UcswrstW<Uca1ctlw0SpiSpec> {
        UcswrstW::new(self, 0)
    }
    #[doc = "Bit 1 - STE mode select in master mode."]
    #[inline(always)]
    pub fn ucstem(&mut self) -> UcstemW<Uca1ctlw0SpiSpec> {
        UcstemW::new(self, 1)
    }
    #[doc = "Bits 6:7 - eUSCI_A clock source select"]
    #[inline(always)]
    pub fn ucssel(&mut self) -> UcsselW<Uca1ctlw0SpiSpec> {
        UcsselW::new(self, 6)
    }
    #[doc = "Bit 8 - Synchronous mode enable"]
    #[inline(always)]
    pub fn ucsync(&mut self) -> UcsyncW<Uca1ctlw0SpiSpec> {
        UcsyncW::new(self, 8)
    }
    #[doc = "Bits 9:10 - eUSCI mode"]
    #[inline(always)]
    pub fn ucmode(&mut self) -> UcmodeW<Uca1ctlw0SpiSpec> {
        UcmodeW::new(self, 9)
    }
    #[doc = "Bit 11 - Master mode select"]
    #[inline(always)]
    pub fn ucmst(&mut self) -> UcmstW<Uca1ctlw0SpiSpec> {
        UcmstW::new(self, 11)
    }
    #[doc = "Bit 12 - Character length"]
    #[inline(always)]
    pub fn uc7bit(&mut self) -> Uc7bitW<Uca1ctlw0SpiSpec> {
        Uc7bitW::new(self, 12)
    }
    #[doc = "Bit 13 - MSB first select"]
    #[inline(always)]
    pub fn ucmsb(&mut self) -> UcmsbW<Uca1ctlw0SpiSpec> {
        UcmsbW::new(self, 13)
    }
    #[doc = "Bit 14 - Clock polarity select"]
    #[inline(always)]
    pub fn ucckpl(&mut self) -> UcckplW<Uca1ctlw0SpiSpec> {
        UcckplW::new(self, 14)
    }
    #[doc = "Bit 15 - Clock phase select"]
    #[inline(always)]
    pub fn ucckph(&mut self) -> UcckphW<Uca1ctlw0SpiSpec> {
        UcckphW::new(self, 15)
    }
}
