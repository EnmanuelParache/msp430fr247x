#[doc = "Register `UCA1CTLW0_SPI` reader"]
pub struct R(crate::R<UCA1CTLW0_SPI_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCA1CTLW0_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCA1CTLW0_SPI_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCA1CTLW0_SPI_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCA1CTLW0_SPI` writer"]
pub struct W(crate::W<UCA1CTLW0_SPI_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCA1CTLW0_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCA1CTLW0_SPI_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCA1CTLW0_SPI_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCSWRST_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA1CTLW0_SPI_SPEC, UCSWRST_A, O>;
...
pub type UCSTEM_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA1CTLW0_SPI_SPEC, UCSTEM_A, O>;
...
pub type UCSSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, UCA1CTLW0_SPI_SPEC, u8, UCSSEL_A, 2, O>;
...
pub type UCSYNC_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA1CTLW0_SPI_SPEC, UCSYNC_A, O>;
...
pub type UCMODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, UCA1CTLW0_SPI_SPEC, u8, UCMODE_A, 2, O>;
...
pub type UCMST_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA1CTLW0_SPI_SPEC, UCMST_A, O>;
...
pub type UC7BIT_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA1CTLW0_SPI_SPEC, UC7BIT_A, O>;
...
pub type UCMSB_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA1CTLW0_SPI_SPEC, UCMSB_A, O>;
...
pub type UCCKPL_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA1CTLW0_SPI_SPEC, UCCKPL_A, O>;
...
pub type UCCKPH_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA1CTLW0_SPI_SPEC, UCCKPH_A, O>;
...
#[doc = "eUSCI_Ax Control Word Register 0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uca1ctlw0_spi](index.html) module"]
pub struct UCA1CTLW0_SPI_SPEC;
impl crate::RegisterSpec for UCA1CTLW0_SPI_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [uca1ctlw0_spi::R](R) reader structure"]
impl crate::Readable for UCA1CTLW0_SPI_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uca1ctlw0_spi::W](W) writer structure"]
impl crate::Writable for UCA1CTLW0_SPI_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UCA1CTLW0_SPI to value 0"]
impl crate::Resettable for UCA1CTLW0_SPI_SPEC {
