...
pub type R = crate::R<Uca1ctlw0SpiSpec>;
#[doc = "Register `UCA1CTLW0_SPI` writer"]
pub type W = crate::W<Uca1ctlw0SpiSpec>;
...
impl W {
    #[doc = "Bit 0 - Software reset enable"]
    #[inline(always)]
    pub fn ucswrst(&mut self) -> UcswrstW<'_, Uca1ctlw0SpiSpec> {
        UcswrstW::new(self, 0)
    }
    #[doc = "Bit 1 - STE mode select in master mode."]
    #[inline(always)]
    pub fn ucstem(&mut self) -> UcstemW<'_, Uca1ctlw0SpiSpec> {
        UcstemW::new(self, 1)
    }
    #[doc = "Bits 6:7 - eUSCI_A clock source select"]
    #[inline(always)]
    pub fn ucssel(&mut self) -> UcsselW<'_, Uca1ctlw0SpiSpec> {
        UcsselW::new(self, 6)
    }
    #[doc = "Bit 8 - Synchronous mode enable"]
    #[inline(always)]
    pub fn ucsync(&mut self) -> UcsyncW<'_, Uca1ctlw0SpiSpec> {
        UcsyncW::new(self, 8)
    }
    #[doc = "Bits 9:10 - eUSCI mode"]
    #[inline(always)]
    pub fn ucmode(&mut self) -> UcmodeW<'_, Uca1ctlw0SpiSpec> {
        UcmodeW::new(self, 9)
    }
    #[doc = "Bit 11 - Master mode select"]
    #[inline(always)]
    pub fn ucmst(&mut self) -> UcmstW<'_, Uca1ctlw0SpiSpec> {
        UcmstW::new(self, 11)
    }
    #[doc = "Bit 12 - Character length"]
    #[inline(always)]
    pub fn uc7bit(&mut self) -> Uc7bitW<'_, Uca1ctlw0SpiSpec> {
        Uc7bitW::new(self, 12)
    }
    #[doc = "Bit 13 - MSB first select"]
    #[inline(always)]
    pub fn ucmsb(&mut self) -> UcmsbW<'_, Uca1ctlw0SpiSpec> {
        UcmsbW::new(self, 13)
    }
    #[doc = "Bit 14 - Clock polarity select"]
    #[inline(always)]
    pub fn ucckpl(&mut self) -> UcckplW<'_, Uca1ctlw0SpiSpec> {
        UcckplW::new(self, 14)
    }
    #[doc = "Bit 15 - Clock phase select"]
    #[inline(always)]
    pub fn ucckph(&mut self) -> UcckphW<'_, Uca1ctlw0SpiSpec> {
        UcckphW::new(self, 15)
    }
}
#[doc = "eUSCI_Ax Control Word Register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`uca1ctlw0_spi::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uca1ctlw0_spi::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Uca1ctlw0SpiSpec;
impl crate::RegisterSpec for Uca1ctlw0SpiSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`uca1ctlw0_spi::R`](R) reader structure"]
impl crate::Readable for Uca1ctlw0SpiSpec {}
#[doc = "`write(|w| ..)` method takes [`uca1ctlw0_spi::W`](W) writer structure"]
impl crate::Writable for Uca1ctlw0SpiSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UCA1CTLW0_SPI to value 0"]
impl crate::Resettable for Uca1ctlw0SpiSpec {}
