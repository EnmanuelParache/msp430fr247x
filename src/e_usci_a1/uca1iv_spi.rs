...
pub struct R(crate::R<UCA1IV_SPI_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCA1IV_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCA1IV_SPI_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCA1IV_SPI_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCA1IV_SPI` writer"]
pub struct W(crate::W<UCA1IV_SPI_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCA1IV_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCA1IV_SPI_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCA1IV_SPI_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct UCA1IV_SPI_SPEC;
impl crate::RegisterSpec for UCA1IV_SPI_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [uca1iv_spi::R](R) reader structure"]
impl crate::Readable for UCA1IV_SPI_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uca1iv_spi::W](W) writer structure"]
impl crate::Writable for UCA1IV_SPI_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UCA1IV_SPI to value 0"]
impl crate::Resettable for UCA1IV_SPI_SPEC {
