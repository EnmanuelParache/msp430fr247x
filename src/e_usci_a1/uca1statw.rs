...
pub struct R(crate::R<UCA1STATW_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCA1STATW_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCA1STATW_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCA1STATW_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCA1STATW` writer"]
pub struct W(crate::W<UCA1STATW_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCA1STATW_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCA1STATW_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCA1STATW_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCADDR_UCIDLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, UCA1STATW_SPEC, UCADDR_UCIDLE_A, O>;
...
pub type UCRXERR_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA1STATW_SPEC, UCRXERR_A, O>;
...
pub type UCBRK_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA1STATW_SPEC, UCBRK_A, O>;
...
pub type UCPE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA1STATW_SPEC, UCPE_A, O>;
...
pub type UCOE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA1STATW_SPEC, UCOE_A, O>;
...
pub type UCFE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA1STATW_SPEC, UCFE_A, O>;
...
pub type UCLISTEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCA1STATW_SPEC, UCLISTEN_A, O>;
...
pub struct UCA1STATW_SPEC;
impl crate::RegisterSpec for UCA1STATW_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [uca1statw::R](R) reader structure"]
impl crate::Readable for UCA1STATW_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uca1statw::W](W) writer structure"]
impl crate::Writable for UCA1STATW_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UCA1STATW to value 0"]
impl crate::Resettable for UCA1STATW_SPEC {
