...
pub type SYSFLTE_R = crate::BitReader<SYSFLTE_A>;
...
impl From<SYSFLTE_A> for bool {
    #[inline(always)]
    fn from(variant: SYSFLTE_A) -> Self {
        variant as u8 != 0
    }
}
impl SYSFLTE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> SYSFLTE_A {
        match self.bits {
            false => SYSFLTE_A::DISABLED,
            true => SYSFLTE_A::ENABLED,
        }
    }
    #[doc = "Checks if the value of the field is `DISABLED`"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == SYSFLTE_A::DISABLED
    }
    #[doc = "Checks if the value of the field is `ENABLED`"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == SYSFLTE_A::ENABLED
    }
}
#[doc = "Field `SYSFLTE` writer - Reset pin filter enable"]
pub type SYSFLTE_W<'a, const O: u8> = crate::BitWriter<'a, u16, SFRRPCR_SPEC, SYSFLTE_A, O>;
impl<'a, const O: u8> SYSFLTE_W<'a, O> {
    #[doc = "Digital filter on reset pin is disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(SYSFLTE_A::DISABLED)
    }
    #[doc = "Digital filter on reset pin is enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(SYSFLTE_A::ENABLED)
    }
}
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sysflte(&mut self) -> SYSFLTE_W<4> {
        SYSFLTE_W::new(self)
    }
