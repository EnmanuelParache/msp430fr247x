...
pub struct R(crate::R<CRCDIRB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CRCDIRB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CRCDIRB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CRCDIRB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CRCDIRB` writer"]
pub struct W(crate::W<CRCDIRB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CRCDIRB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CRCDIRB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CRCDIRB_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
