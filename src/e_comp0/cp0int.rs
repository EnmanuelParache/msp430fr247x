...
pub struct R(crate::R<CP0INT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CP0INT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CP0INT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CP0INT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CP0INT` writer"]
pub struct W(crate::W<CP0INT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CP0INT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CP0INT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CP0INT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CPIFG_W<'a, const O: u8> = crate::BitWriter<'a, u16, CP0INT_SPEC, CPIFG_A, O>;
...
pub type CPIIFG_W<'a, const O: u8> = crate::BitWriter<'a, u16, CP0INT_SPEC, CPIIFG_A, O>;
