...
pub struct R(crate::R<CP0DACDATA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CP0DACDATA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CP0DACDATA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CP0DACDATA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CP0DACDATA` writer"]
pub struct W(crate::W<CP0DACDATA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CP0DACDATA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CP0DACDATA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CP0DACDATA_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CPDACBUF1_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, CP0DACDATA_SPEC, u8, CPDACBUF1_A, 6, O>;
...
pub type CPDACBUF2_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, CP0DACDATA_SPEC, u8, CPDACBUF2_A, 6, O>;
