...
pub struct R(crate::R<CP0IV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CP0IV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CP0IV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CP0IV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CP0IV` writer"]
pub struct W(crate::W<CP0IV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CP0IV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CP0IV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CP0IV_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Comparator Interrupt Vector Word Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cp0iv](index.html) module"]
pub struct CP0IV_SPEC;
impl crate::RegisterSpec for CP0IV_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [cp0iv::R](R) reader structure"]
impl crate::Readable for CP0IV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cp0iv::W](W) writer structure"]
impl crate::Writable for CP0IV_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CP0IV to value 0"]
impl crate::Resettable for CP0IV_SPEC {
