...
pub struct R(crate::R<CP0CTL1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CP0CTL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CP0CTL1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CP0CTL1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CP0CTL1` writer"]
pub struct W(crate::W<CP0CTL1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CP0CTL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CP0CTL1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CP0CTL1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CPINV_W<'a, const O: u8> = crate::BitWriter<'a, u16, CP0CTL1_SPEC, CPINV_A, O>;
...
pub type CPIES_W<'a, const O: u8> = crate::BitWriter<'a, u16, CP0CTL1_SPEC, CPIES_A, O>;
...
pub type CPFLT_W<'a, const O: u8> = crate::BitWriter<'a, u16, CP0CTL1_SPEC, CPFLT_A, O>;
...
pub type CPFLTDLY_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, CP0CTL1_SPEC, u8, CPFLTDLY_A, 2, O>;
...
pub type CPMSEL_W<'a, const O: u8> = crate::BitWriter<'a, u16, CP0CTL1_SPEC, CPMSEL_A, O>;
...
pub type CPEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, CP0CTL1_SPEC, CPEN_A, O>;
...
pub type CPHSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, CP0CTL1_SPEC, u8, CPHSEL_A, 2, O>;
...
pub type CPIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, CP0CTL1_SPEC, CPIE_A, O>;
...
pub type CPIIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, CP0CTL1_SPEC, CPIIE_A, O>;
