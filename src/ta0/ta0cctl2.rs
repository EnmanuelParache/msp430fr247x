...
impl From<crate::R<TA0CCTL2_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<TA0CCTL2_SPEC>> for W {
    #[inline(always)]
...
pub type CCIFG_W<'a, const O: u8> = crate::BitWriter<'a, u16, TA0CCTL2_SPEC, CCIFG_A, O>;
...
pub type COV_W<'a, const O: u8> = crate::BitWriter<'a, u16, TA0CCTL2_SPEC, COV_A, O>;
...
pub type OUT_W<'a, const O: u8> = crate::BitWriter<'a, u16, TA0CCTL2_SPEC, OUT_A, O>;
...
pub type CCIE_W<'a, const O: u8> = crate::BitWriter<'a, u16, TA0CCTL2_SPEC, CCIE_A, O>;
...
pub type OUTMOD_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, TA0CCTL2_SPEC, u8, OUTMOD_A, 3, O>;
...
pub type CAP_W<'a, const O: u8> = crate::BitWriter<'a, u16, TA0CCTL2_SPEC, CAP_A, O>;
...
pub type SCCI_W<'a, const O: u8> = crate::BitWriter<'a, u16, TA0CCTL2_SPEC, bool, O>;
...
pub type SCS_W<'a, const O: u8> = crate::BitWriter<'a, u16, TA0CCTL2_SPEC, SCS_A, O>;
...
pub type CCIS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u16, TA0CCTL2_SPEC, u8, CCIS_A, 2, O>;
...
pub type CM_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u16, TA0CCTL2_SPEC, u8, CM_A, 2, O>;
